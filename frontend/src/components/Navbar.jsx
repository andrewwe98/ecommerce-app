    ...
    return (
        <div className="w-full flex items-center justify-between px-6 py-4 bg-white">
            ...
            <div className="flex-1 flex justify-center">
                <ul className="flex gap-5 text-sm text-gray-700 font-medium">
                    <li>
                        <NavLink
                            to="/"
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="group relative">
                    ...
                    <div className="dropdown-menu hidden group-hover:block right-0 pt-4 absolute">
                ...
                <Link to="/cart" className="relative">
                    ...
                    <p className='absolute right-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-xs'>0</p>
                </Link>
